...
def search_routes(route):
    ...
    small_visited_twice = not len(set(small_caves_visited)) == len(small_caves_visited)
    ...
    for i in route[-1].connections:
        ...
        elif i.mode == "small" and (i not in small_caves_visited or not small_visited_twice):
        ...
        # geen loops in big caves
        elif len(route) > 3 and route[-3] == route[-1] and route[-2] == i and route[-1].mode == "big" and i.mode == "big":
            continue
